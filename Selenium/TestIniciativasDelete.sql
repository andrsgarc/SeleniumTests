...
select * from ini_iniciativa where nombre_iniciativa = 'IniSel2014M88';


delete from org_firmante where ini_iniciativa_fk = (Select max(ini.ini_iniciativa_pk) from ini_iniciativa ini where ini.nombre_iniciativa = 'IniSel2014M88');
...
(Select max(ini.ini_iniciativa_pk) from ini_iniciativa ini where ini.nombre_iniciativa = 'IniSel2014M88')));
...
delete from ini_iniciativa_campana where ini_iniciativa_fk = (Select max(ini.ini_iniciativa_pk) from ini_iniciativa ini where ini.nombre_iniciativa = 'IniSel2014M88');

delete from camp_campana where camp_campana_pk = v_campanniaPk;

delete from ini_control where ini_iniciativa_fk = (Select max(ini.ini_iniciativa_pk) from ini_iniciativa ini where ini.nombre_iniciativa = 'IniSel2014M88');

delete from ini_presupuesto where ini_iniciativa_fk = (Select max(ini.ini_iniciativa_pk) from ini_iniciativa ini where ini.nombre_iniciativa = 'IniSel2014M88');

delete from ini_iniciativa where ini_iniciativa_pk = (Select max(ini.ini_iniciativa_pk) from ini_iniciativa ini where ini.nombre_iniciativa = 'IniSel2014M88');
