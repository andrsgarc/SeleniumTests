...
public class OrdenServicioPage {
	...
	public void openFormSerOrdenServicio(){		
	    ...
	    new Select(driver.findElement(By.id("formSerOrdenServicio:cmbDireccion"))).selectByVisibleText("Negocio Comunicaci�n");
	    driver.findElement(By.id("formSerOrdenServicio:cbNegocio")).click();
	    new Select(driver.findElement(By.id("formSerOrdenServicio:cmbNegocio"))).selectByVisibleText("Comunicaci�n");
	    new Select(driver.findElement(By.id("formSerOrdenServicio:cmbProceso"))).selectByVisibleText("Negocio Comunicaci�n");
	    new Select(driver.findElement(By.id("formSerOrdenServicio:cmbTipoContrato"))).selectByVisibleText("Agencias de publicidad y producci�n");
