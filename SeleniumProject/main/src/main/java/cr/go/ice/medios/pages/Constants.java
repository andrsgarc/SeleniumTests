...
public interface Constants {
	...
	//Constantes orden de servicio
	
	public static String ORDEN_SERVICIO_PAUTA_NUMERO = "398199"; 
	
	public static String ORDEN_SERVICIO_NUMERO = "398200"; 
	public static String ORDEN_SERVICIO_CONTRATACION = "45936801"; 
